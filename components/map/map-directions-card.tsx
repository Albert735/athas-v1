...
export default function MapDirectionsCard({
  ...
  const [mode, setMode] = useState<TransportProfile>("walking");
  ...
  return (
    <View style={[styles.sheet, { backgroundColor: cardColor }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: textColor }]}>Directions</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  routeCard: { padding: 16, borderRadius: 20, marginBottom: 20 },
  routeRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  dot: { width: 10, height: 10, borderRadius: 5 },
  startDot: { backgroundColor: "#3B82F6" },
  ...
  destination: { fontSize: 14, fontWeight: "700" },
  modes: { flexDirection: "row", gap: 10, marginBottom: 20 },
  modeButton: {
    flex: 1,
    height: 42,
    borderRadius: 21,
  ...
  duration: { fontSize: 22, fontWeight: "800", color: "#10B981" },
  ...
  fastestText: { color: "#10B981", fontSize: 12, fontWeight: "700" },
});
